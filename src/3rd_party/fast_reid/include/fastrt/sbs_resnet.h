...
public:
    backbone_sbsR18_distill(FastreidConfig &modelCfg) :
        _modelCfg(modelCfg) {
    }
...
public:
    backbone_sbsR34_distill(FastreidConfig &modelCfg) :
        _modelCfg(modelCfg) {
    }
...
public:
    backbone_sbsR50_distill(FastreidConfig &modelCfg) :
        _modelCfg(modelCfg) {
    }
...
public:
    backbone_sbsR34(FastreidConfig &modelCfg) :
        _modelCfg(modelCfg) {
    }
...
public:
    backbone_sbsR50(FastreidConfig &modelCfg) :
        _modelCfg(modelCfg) {
    }
